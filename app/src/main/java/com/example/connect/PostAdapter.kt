...
class PostAdapter(options: FirestoreRecyclerOptions<Post>, private val listener: IPostAdapter) : FirestoreRecyclerAdapter<Post, PostViewHolder>(
    options
) {
    ...
    override fun onBindViewHolder(holder: PostViewHolder, position: Int, model: Post) {
        ...
        val isLiked = model.likedBy.contains(auth.currentUser!!.uid)
        if(isLiked)
